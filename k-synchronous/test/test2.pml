...
Send:
  atomic{ SendActionToChannel(_pid, P2ID, C2, Hello); goto Rec }
  
Rec:
  atomic{ flag?true ->
	  C1?Hello -> changeFlag(); goto Send }
}

proctype P2() {

Send:
  atomic{ SendActionToChannel(_pid, P3ID, C3, Hello); goto Rec }
  
Rec:
  atomic{ flag?true ->
	  C2?Hello -> changeFlag(); goto Send }
}
...
Send:
  atomic{ SendActionToChannel(_pid, P1ID, C1, Hello); goto Rec }
  
Rec:
  atomic{ flag?true ->
	  C3?Hello -> changeFlag(); goto Send }
}
